...
from tasks.retrain_task import run_weekly_retraining
...
class TestRetrainingTask:
    ...
    async def test_run_weekly_retraining_success(self):
        ...
        respx.post("http://ml_service:8001/retrain").mock(
    ...
    async def test_run_weekly_retraining_connection_error(self):
        ...
        respx.post("http://ml_service:8001/retrain").side_effect = Exception("Connection refused")
